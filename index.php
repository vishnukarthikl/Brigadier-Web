				...
				<div class="wrapper">
					<section class="col1">
						...
						<div class="wrapper">
							...
							<p class="pad_bot1">Hello, Everyone!!! <br/><br/></p>
							<p>Brigadier helps you to protect phone accounts data securely. <br/><br/>Manage all your contacts including the blacklists from here. </p>
						</div>
					</section>
					<section class="col2 pad_left1">
					<div class="wrapper">
					<h2 class="under">Get Brigaded! </h2>
						<form id="ClickButton">
							<span><strong class="color1">Already a member ? <a href="login.php">Sign In</a></strong></span><br/><br/><br/><br/>
							<span><strong class="color1">Not yet protected ? <a href="register.php">Sign Up</a></strong></span>
						</form>
						</div>
					</section>
				</div>
